 ...
 * @Date: 2024-04-28 16:19:01
 * @FilePath: \handwrite_rpc\easy-rpc-core\src\main\java\com\p1nkpeach\easyrpccore\registry\ZooKeeperRegistry.java
 * @Description: zookeeper 注册中心
 * @Opt-doc: <a href="https://curator.apache.org/docs/getting-started">Apache Curator</a>
 * @Code-example: <a href="https://github.com/apache/curator/blob/master/curator-examples/src/main/java/discovery/DiscoveryExample.java">DiscoveryExample.java</a>
 * @WatchKey-example: <a href="https://github.com/apache/curator/blob/master/curator-examples/src/main/java/cache/CuratorCacheExample.java">CuratorCacheExample.java</a>
 */
...
public class ZooKeeperRegistry implements Registry {
    ...
    public List<ServiceMetaInfo> discovery(String serviceKey) {
        // 优先从缓存获取服务
        List<ServiceMetaInfo> cachedServiceMetaInfoList = registryServiceCache.read();
